...
if (!defined("FOLD_PROYECT")) define("FOLD_PROY", $_SERVER["CONTEXT_DOCUMENT_ROOT"] . "/Alejandro/Paginas/Software-Casilleros-copia/");
...
if (!defined("URL_PROY")) define("URL_PROY", "/Alejandro/Paginas/Software-Casilleros-copia/");
